...
public class Dev {
    ...
    private String nome;
    private Set<Conteudo> conteudosInscritos = new LinkedHashSet<>();//Lista organizada
    private Set<Conteudo> conteudosConcluidos = new LinkedHashSet<>();//Lista para evitar elementos unicos
